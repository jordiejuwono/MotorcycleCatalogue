...
import com.jordju.motorcyclecatalogue.databinding.ItemSliderBinding

class SliderAdapter(private val items: List<ImageData>) : RecyclerView.Adapter<SliderAdapter.ImageViewHolder>() {

    class ImageViewHolder(itemView: ItemSliderBinding) : RecyclerView.ViewHolder(itemView.root) {
